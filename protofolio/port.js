...
$('.dark').click(function () { 
 ...
 $('#about').css('background-color' , '#31313a');
 ...
 $('.orginal').click(function () {
     ...
     $('.title').css('background-color' , '#f26b38')
     $('h3').css('color', '#141414')
 });
...
$('.blue').click(function () { 
    $('body').hide().fadeIn(4000);
     $('body').attr('class' , 'blueClass');
     $('.wrappe').addClass('def');
     $('.nav-link').css('color' , '#0856c1');
     $('button').css('background-color' , '#0856c1');
     $('svg').css('color' , '#0856c1');
     $('.highlighted').css('color' , '#0856c1');
     $('.progress-bar').css('background-color' , '#0856c1');
     $('.progress-bar').css('color' , '#fff');
